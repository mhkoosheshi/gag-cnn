    ...
    for k in tests:
        ...
        for i in range(0, 15):
            ...
            with plt.ioff():
                ...
                plt.axis('off')
                sns.heatmap(W_[i], annot=False, cmap='Oranges', xticklabels=False, yticklabels=False, ax=axs[0,2], cbar=False)
                plt.axis('off')
                sns.heatmap(S_[i], annot=False, cmap='Blues', xticklabels=False, yticklabels=False, ax=axs[0,3], cbar=False)
                plt.axis('off')
                sns.heatmap(C_[i], annot=False, cmap='Purples', xticklabels=False, yticklabels=False, ax=axs[0,4], cbar=False)
                plt.axis('off')
                sns.heatmap(Q[i], annot=False, cmap='Reds', xticklabels=False, yticklabels=False, ax=axs[1,1], cbar=False)
                plt.axis('off')
                sns.heatmap(W[i], annot=False, cmap='Oranges', xticklabels=False, yticklabels=False, ax=axs[1,2], cbar=False)
                plt.axis('off')
                sns.heatmap(S[i], annot=False, cmap='Blues', xticklabels=False, yticklabels=False, ax=axs[1,3], cbar=False)
                plt.axis('off')
                sns.heatmap(C[i], annot=False, cmap='Purples', xticklabels=False, yticklabels=False, ax=axs[1,4], cbar=False)
                plt.axis('off')
